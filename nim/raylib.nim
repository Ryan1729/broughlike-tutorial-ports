...
proc IsWindowMaximized*(): bool {.RLAPI, importc: "IsWindowMaximized".} # Check if window has been maximized (only PLATFORM_DESKTOP)
...
proc DecorateWindow*() {.RLAPI, importc: "DecorateWindow".} # Decorate the window (only PLATFORM_DESKTOP)
proc UndecorateWindow*() {.RLAPI, importc: "UndecorateWindow".} # Undecorate the window (only PLATFORM_DESKTOP)
proc MaximizeWindow*() {.RLAPI, importc: "MaximizeWindow".} # Maximize the window, if resizable (only PLATFORM_DESKTOP)
proc RestoreWindow*() {.RLAPI, importc: "RestoreWindow".} # Restore the window, if resizable (only PLATFORM_DESKTOP)
